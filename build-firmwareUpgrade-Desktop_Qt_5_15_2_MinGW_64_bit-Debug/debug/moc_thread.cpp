...
#include <memory>
#include "../../firmwareUpgrade/thread/thread.h"
...
QT_MOC_LITERAL(1, 7, 12), // "threadFinish"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6), // "status"
QT_MOC_LITERAL(4, 28, 4), // "info"
QT_MOC_LITERAL(5, 33, 22), // "mainThreadExitedSignal"
QT_MOC_LITERAL(6, 56, 16), // "mainThreadExited"
QT_MOC_LITERAL(7, 73, 15) // "parseStatusFile"

    },
    "thread\0threadFinish\0\0status\0info\0"
...
void thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (thread::*)(bool , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&thread::threadFinish)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&thread::mainThreadExitedSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void thread::threadFinish(bool _t1, QString _t2)
{
...
// SIGNAL 1
void thread::mainThreadExitedSignal()
{
